...
murl = "https://iiif.manducus.net/collections/0008/collection.json"
...
template = '''
{
  ...
  "@id":"https://iiif.manducus.net/annotations/antlitzninja_faces_staedel.json",
...
with open("antlitz_faces_staedel.json", 'w') as outfile:

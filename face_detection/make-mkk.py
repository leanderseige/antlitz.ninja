...
murl = "https://iiif.manducus.net/collections/0020/collection.json"
...
template = '''
{
  ...
  "@id":"https://iiif.manducus.net/annotations/antlitzninja_faces_mkk.json",
...
with open("antlitz_faces_mkk.json", 'w') as outfile:
